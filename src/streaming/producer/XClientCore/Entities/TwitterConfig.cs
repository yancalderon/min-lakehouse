...
namespace TwitterClient
{
    public struct TwitterConfig
    {
        ...
        public TwitterConfig(string oauthToken, string oauthTokenSecret, string oauthConsumerKey, string oauthConsumerSecret, string keywords, string bearerToken = null)
        {
